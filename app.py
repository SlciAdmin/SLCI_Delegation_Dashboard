...
✅ FIXED: DateTime import error + Render.com Deployment Ready
"""
import os
import sys
import urllib.parse
...
# ✅ Initialize LoginManager BEFORE any route uses current_user
...
def init_database():
    ...
    for attempt in range(max_retries):
        try:
            ...
            logger.warning(f"⚠️ DB attempt {attempt + 1} failed: {str(e)}")
...
def generate_whatsapp_link(phone_number, message):
    ...
    return f"https://wa.me/{clean_phone}?text={encoded_message}"  # ✅ Fixed: removed extra spaces
...
class TaskDocument(db.Model):
    ...
    # ✅ FIXED: db.DateTime instead of DateTime
